...
@NamedQueries({
    ...
    , @NamedQuery(name = "Compras.findActivos", query = "SELECT c FROM Compras c WHERE c.status = 1")
    , @NamedQuery(name = "Compras.findEliminados", query = "SELECT c FROM Compras c WHERE c.status = 0")    
