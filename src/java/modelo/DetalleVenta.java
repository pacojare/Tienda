...
@NamedQueries({
    ...
    , @NamedQuery(name = "DetalleVenta.findActivos", query = "SELECT d FROM DetalleVenta d WHERE d.status = 1")
    , @NamedQuery(name = "DetalleVenta.findEliminados", query = "SELECT d FROM DetalleVenta d WHERE d.status = 0")    
